...
```bash
grep -c SwitchVN ~/.local/share/Steam/compatibilitytools.d/GE-Proton11-5-SwitchVN-1/compatibilitytool.vdf
```
...
## GE-Proton11-5-SwitchVN-1 does not appear in Steam
