...
```bash
grep -c SwitchVN ~/.local/share/Steam/compatibilitytools.d/GE-Proton11-3-SwitchVN-3/compatibilitytool.vdf
```
...
## GE-Proton11-3-SwitchVN-3 does not appear in Steam
