...
```bash
grep -c SwitchVN ~/.local/share/Steam/compatibilitytools.d/GE-Proton11-3-SwitchVN-2/compatibilitytool.vdf
```
...
## GE-Proton11-3-SwitchVN-2 does not appear in Steam
